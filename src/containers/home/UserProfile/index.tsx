    ...
    >
      ...
      <UserProfileStack.Group>
        <UserProfileStack.Screen
          name={screenName.JOB_TITLE}
          component={JobTitle}
        />
        <UserProfileStack.Screen name={screenName.SCHOOL} component={School} />
        <UserProfileStack.Screen
          name={screenName.EDUCATION_LEVEL}
          component={EducationLevel}
        />
        <UserProfileStack.Screen
          name={screenName.HOMETOWN}
          component={Hometown}
        />
        <UserProfileStack.Screen
          name={screenName.COMPANY}
          component={Company}
        />

        <UserProfileStack.Screen
          name={screenName.ETHNICITY}
          component={Ethnicity}
        />
        <UserProfileStack.Screen name={screenName.SPORTS} component={Sports} />
        <UserProfileStack.Screen
          name={screenName.SMOKING}
          component={Smoking}
        />
        <UserProfileStack.Screen
          name={screenName.CANNABIS}
          component={Cannabis}
        />
        <UserProfileStack.Screen
          name={screenName.ALCOHOL}
          component={Alcohol}
        />
        <UserProfileStack.Screen name={screenName.DRUGS} component={Drugs} />
        <UserProfileStack.Screen name={screenName.DIET} component={Diet} />
        <UserProfileStack.Screen
          name={screenName.LANGUAGES}
          component={Languages}
        />
        <UserProfileStack.Screen
          name={screenName.MUSIC_GENRES}
          component={MusicGenre}
        />
        <UserProfileStack.Screen
          name={screenName.CREATIVE_OUTLET}
          component={CreativeOulet}
        />
        <UserProfileStack.Screen
          name={screenName.RELIGIONS}
          component={Religions}
        />
        <UserProfileStack.Screen
        ...
        <UserProfileStack.Screen
          name={screenName.MEYER_BRIGGS}
          component={MeyerBriggs}
        />
        <UserProfileStack.Screen
          name={screenName.POLITICS}
          component={Politics}
        />
        <UserProfileStack.Screen
          name={screenName.PARENTING_GOALS}
          component={ParentingGoals}
        />
        <UserProfileStack.Screen
        ...
        <UserProfileStack.Screen
          name={screenName.BOOK_GENRES}
          component={BookGenre}
        />
        <UserProfileStack.Screen
          name={screenName.STAYING_IN}
          component={StayingIn}
        />
        <UserProfileStack.Screen
          name={screenName.GOING_OUT}
          component={GoingOut}
        />
