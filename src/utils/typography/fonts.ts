...
export const FONT_FAMILY = {
  ...
  RobotoSerif_100Thin_Italic: "RobotoSerif_100Thin_Italic",
  RobotoSerif_200ExtraLight_Italic: "RobotoSerif_200ExtraLight_Italic",
  RobotoSerif_300Light_Italic: "RobotoSerif_300Light_Italic",
...
export const FONT_TIENNE_REGULAR = " Tienne_400Regular";
export const FONT_TIENNE_BOLD = "Tienne_700Bold";
export const FONT_CAPRIOLA_REGULAR = "Capriola_400Regular";
